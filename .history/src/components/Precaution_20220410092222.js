        ...
        <Grid container columnSpacing={1} rowSpacing={8}>
          <Grid item lg={4} md={6} sm={6} xs={12} >
            <div data-aos="fade-up" className="guidelines">
              ...
              <br />
              <p className="guideContain">Identify potential hazards in your home and  identify them</p>
            </div>
          </Grid>
          <Grid item lg={4} md={6} sm={6} xs={12} >
            <div data-aos="fade-up" className="guidelines">
          ...
          <Grid item lg={4} md={6} sm={6} xs={12} >
            <div data-aos="fade-up" className="guidelines">
              ...
              <br />
              <p className="guideContain">Identify your building's potential weaknesses and evaluate them</p>
            </div>
          </Grid>
          <Grid item lg={4} md={6} sm={6} xs={12} >
            <div data-aos="fade-up" className="guidelines">
