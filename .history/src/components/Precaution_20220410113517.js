...
function Precaution() {
  ...
  return (
    <div id="Guidelines" className='mobileview' style={{ color: "black", backgroundColor: "white", padding: '0 8%', marginBottom: '4%' }}>
        ...
        <Grid container columnSpacing={1} rowSpacing={8}>
          <Grid item lg={4} md={6} sm={6} xs={12} >
            <div data-aos="fade-up" className="guidelines">
              ...
              <br />
              <p className="guideContain">Identify potential hazards in your home </p>
            </div>
          </Grid>
          <Grid item lg={4} md={6} sm={6} xs={12} >
            <div data-aos="fade-up" className="guidelines">
          ...
          <Grid item lg={4} md={6} sm={6} xs={12} >
            <div data-aos="fade-up" className="guidelines">
              ...
              <br />
              <p className="guideContain">Stay away from weak buildings</p>
            </div>
          </Grid>
          <Grid item lg={4} md={6} sm={6} xs={12} >
            <div data-aos="fade-up" className="guidelines">
              ...
              <br />
              <p className="guideContain">Cater to your injuries and damage</p>
            </div>
          </Grid>
          <Grid item lg={4} md={6} sm={6} xs={12} >
            <div data-aos="fade-up" className="guidelines">
              ...
              <br />
              <p className="guideContain">Always follow disaster rescue plan</p>
            </div>
          </Grid>
