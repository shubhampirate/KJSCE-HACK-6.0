...
async function fetchFunction() {
  try{
	const response = await axios.get(`https://api.reliefweb.int/v1/reports?appname=apidoc&query[value]=earthquake|cyclone|flood|tsunami`);
 ...
 const news= async () => {
  ...
  const data = await Axios({
      url: `https://api.reliefweb.int/v1/reports?appname=apidoc&query[value]=earthquake|cyclone|flood|tsunami`,
      method: "GET",
      headers: {
